...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  var e = Math.PI / 180,
    ...
    d = function (r, n, o, i, a, s, h, l, f) {
      if (r !== l || n !== f) {
        ...
        V = Math.sqrt((q * q + I * I) * (Y * Y + B * B)),
          X = q * Y + I * B,
          x = 0 > q * B - I * Y ? -1 : 1;
        var R = x * Math.acos(X / V) * t;
        !h && R > 0 ? R -= 360 : h && 0 > R && (R += 360),
          R %= 360,
          O %= 360;
        var j,
          F,
    ...
    O = function (e, t, r) {
      var i,
        a,
        h = "string" == typeof e;
      return (!h || o.test(e) || (e.match(n) || []).length < 3) && (i = h ? s.selector(e) : e && e[0] ? e : [e], i && i[0] ? (i = i[0], a = i.nodeName.toUpperCase(), t && "PATH" !== a && (i = X(i, !1), a = "PATH"), e = i.getAttribute("PATH" === a ? "d" : "points") || "", i === r && (e = i.getAttributeNS(null, "data-original") || e)) : (c("WARNING: invalid morph to: " + e), e = !1)),
        e
    },
  ...
  j.pathFilter = L,
    j.pointsFilter = Y,
    j.subdivideRawBezier = v,
    j.defaultMap = "size",
    j.pathDataToRawBezier = function (e) {
      return m(O(e, !0))
    },
    j.equalizeSegmentQuantity = T,
  ...
  "function" == typeof define && define.amd ? define(["gsap"], t) : "undefined" != typeof module && module.exports && (require("gsap"), module.exports = t())
}
("MorphSVGPlugin");
